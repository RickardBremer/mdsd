 ...
 * <ul>
 *   <li>{@link model.UserExpert#getUser <em>User</em>}</li>
...
public interface UserExpert extends EObject {
	 ...
	 * @see #setUser(User)
	 * @see model.ModelPackage#getUserExpert_User()
	...
	/**
	 * Sets the value of the '{@link model.UserExpert#getUser <em>User</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
