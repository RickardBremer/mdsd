 ...
 * <ul>
 *   <li>{@link model.PromotionExpert#getPromotion <em>Promotion</em>}</li>
...
public interface PromotionExpert extends EObject {
	/**
	 * Returns the value of the '<em><b>Promotion</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Promotion</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Promotion</em>' reference.
	 * @see #setPromotion(Promotion)
	 * @see model.ModelPackage#getPromotionExpert_Promotion()
	...
	/**
	 * Sets the value of the '{@link model.PromotionExpert#getPromotion <em>Promotion</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Promotion</em>' reference.
	 * @see #getPromotion()
	 * @generated
	 */
