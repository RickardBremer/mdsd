...
public interface ModelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RECEIPT___ADD_EXPENSE__EXPENSE = 1;
	 ...
	 * @ordered
	 */
	int RECEIPT___REMOVE_EXPENSE__EXPENSE = 2;
	 ...
	 * @ordered
	 */
	int RECEIPT___GET_ALL_EXPENSES = 3;
	 ...
	 * @ordered
	 */
	int ROOM_EXPERT_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int ROOM_EXPERT___GET_AVAILABLE_ROOM_TYPES__DATE_DATE_INT_INT_ROOM = 1;
	 ...
	 * @ordered
	 */
	int EXPENSE_EXPERT__DATABASE = 1;
	 ...
	 * @ordered
	 */
	int EXPENSE_EXPERT_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int USER_EXPERT_FEATURE_COUNT = 2;
	...
	/**
	 * The feature id for the '<em><b>Promotion</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROMOTION_EXPERT__PROMOTION = 0;
	 ...
	 * @ordered
	 */
	int PROMOTION_EXPERT__DATABASE = 1;
	 ...
	 * @ordered
	 */
	int PROMOTION_EXPERT_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int BOOKING_EXPERT__DATABASE = 1;
	 ...
	 * @ordered
	 */
	int BOOKING_EXPERT_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int RECEIPT_EXPERT__DATABASE = 1;
	 ...
	 * @ordered
	 */
	int RECEIPT_EXPERT_FEATURE_COUNT = 2;
	...
	/**
	 * Returns the meta object for the reference list '{@link model.Booking#getRooms <em>Rooms</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Rooms</em>'.
	 * @see model.Booking#getRooms()
	 * @see #getBooking()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link model.RoomExpert#getRoom <em>Room</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Room</em>'.
	 * @see model.RoomExpert#getRoom()
	 * @see #getRoomExpert()
	 * @generated
	 */
	EReference getRoomExpert_Room();
	...
	/**
	 * Returns the meta object for the '{@link model.RoomExpert#getAvailableRoomTypes(java.util.Date, java.util.Date, int, int, model.Room) <em>Get Available Room Types</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Available Room Types</em>' operation.
	 * @see model.RoomExpert#getAvailableRoomTypes(java.util.Date, java.util.Date, int, int, model.Room)
	 * @generated
	 */
	EOperation getRoomExpert__GetAvailableRoomTypes__Date_Date_int_int_Room();
	...
	/**
	 * Returns the meta object for the reference '{@link model.ExpenseExpert#getExpense <em>Expense</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Expense</em>'.
	 * @see model.ExpenseExpert#getExpense()
	 * @see #getExpenseExpert()
	 * @generated
	 */
	EReference getExpenseExpert_Expense();
	...
	/**
	 * Returns the meta object for the reference '{@link model.UserExpert#getUser <em>User</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>User</em>'.
	 * @see model.UserExpert#getUser()
	 * @see #getUserExpert()
	 * @generated
	 */
	EReference getUserExpert_User();
	...
	/**
	 * Returns the meta object for the reference '{@link model.PromotionExpert#getPromotion <em>Promotion</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Promotion</em>'.
	 * @see model.PromotionExpert#getPromotion()
	 * @see #getPromotionExpert()
	 * @generated
	 */
	EReference getPromotionExpert_Promotion();
	...
	/**
	 * Returns the meta object for the reference '{@link model.BookingExpert#getBooking <em>Booking</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Booking</em>'.
	 * @see model.BookingExpert#getBooking()
	 * @see #getBookingExpert()
	 * @generated
	 */
	EReference getBookingExpert_Booking();
	...
	/**
	 * Returns the meta object for the reference '{@link model.ReceiptExpert#getReceipt <em>Receipt</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Receipt</em>'.
	 * @see model.ReceiptExpert#getReceipt()
	 * @see #getReceiptExpert()
	 * @generated
	 */
	EReference getReceiptExpert_Receipt();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference ROOM_EXPERT__ROOM = eINSTANCE.getRoomExpert_Room();
		 ...
		 * @generated
		 */
		EOperation ROOM_EXPERT___GET_AVAILABLE_ROOM_TYPES__DATE_DATE_INT_INT_ROOM = eINSTANCE.getRoomExpert__GetAvailableRoomTypes__Date_Date_int_int_Room();
		 ...
		 * @generated
		 */
		EReference EXPENSE_EXPERT__EXPENSE = eINSTANCE.getExpenseExpert_Expense();
		 ...
		 * @generated
		 */
		EReference USER_EXPERT__USER = eINSTANCE.getUserExpert_User();
		...
		/**
		 * The meta object literal for the '<em><b>Promotion</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference PROMOTION_EXPERT__PROMOTION = eINSTANCE.getPromotionExpert_Promotion();
		 ...
		 * @generated
		 */
		EReference BOOKING_EXPERT__BOOKING = eINSTANCE.getBookingExpert_Booking();
		 ...
		 * @generated
		 */
		EReference RECEIPT_EXPERT__RECEIPT = eINSTANCE.getReceiptExpert_Receipt();
