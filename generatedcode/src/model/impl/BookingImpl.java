 ...
 *   <li>{@link model.impl.BookingImpl#getRooms <em>Rooms</em>}</li>
...
public class BookingImpl extends MinimalEObjectImpl.Container implements Booking {
	...
	public EList<Room> getRooms() {
		if (rooms == null) {
			rooms = new EObjectResolvingEList<Room>(Room.class, this, ModelPackage.BOOKING__ROOMS);
		}
		return rooms;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.BOOKING__ROOM_TYPES:
				return getRoomTypes();
			case ModelPackage.BOOKING__ROOMS:
				return getRooms();
