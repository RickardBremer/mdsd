 ...
 * <ul>
 *   <li>{@link model.impl.PromotionExpertImpl#getPromotion <em>Promotion</em>}</li>
...
public class PromotionExpertImpl extends MinimalEObjectImpl.Container implements PromotionExpert {
	/**
	 * The cached value of the '{@link #getPromotion() <em>Promotion</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPromotion()
	 * @generated
		...
		if (promotion != null && promotion.eIsProxy()) {
			...
			if (promotion != oldPromotion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.PROMOTION_EXPERT__PROMOTION, oldPromotion, promotion));
			}
		}
		return promotion;
	}
	...
	public void setPromotion(Promotion newPromotion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PROMOTION_EXPERT__PROMOTION, oldPromotion, promotion));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.PROMOTION_EXPERT__PROMOTION:
