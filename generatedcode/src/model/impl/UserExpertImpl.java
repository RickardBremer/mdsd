 ...
 * <ul>
 *   <li>{@link model.impl.UserExpertImpl#getUser <em>User</em>}</li>
...
public class UserExpertImpl extends MinimalEObjectImpl.Container implements UserExpert {
		...
		if (user != null && user.eIsProxy()) {
			...
			if (user != oldUser) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.USER_EXPERT__USER, oldUser, user));
			}
		}
		return user;
	}
	...
	public void setUser(User newUser) {
		...
		user = newUser;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.USER_EXPERT__USER, oldUser, user));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.USER_EXPERT__USER:
